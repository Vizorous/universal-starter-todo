/**
 * @generated SignedSource<<78747448c086b5bce027db5950595c96>>
...
export type TodosFragment$data = {
  readonly todos: {
...
export type TodosFragment$key = {
  readonly " $data"?: TodosFragment$data;
  readonly " $fragmentSpreads": FragmentRefs<"TodosFragment">;
};

import TodosRefetchQuery_graphql from './TodosRefetchQuery.graphql';
...
return {
  ...
  "metadata": {
    ...
    "refetch": {
      ...
      "operation": TodosRefetchQuery_graphql
    }
  },
  "name": "TodosFragment",
  "selections": [
    {
      ...
      "kind": "LinkedField",
      "name": "__TodosFragment_todos_connection",
      "plural": false,
      "selections": [
        {
          "alias": null,
